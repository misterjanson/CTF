...
![alt text](SunTzu.png?width=300px)
...
With a better understanding of an attacker's sequence you can now identify gaps in security and identify which solutions can best fill those gaps.

![](attack_sequence.JPG?width=600px)
