...
**Process Modification** [ID:DC0020](https://attack.mitre.org/datacomponents/DC0020/)
...
Use FortiAnalyzer to review events, logs, and configurations to find the following flags:
...
| 2 | **ID, Please:** What is the MITRE Tech ID for the Process Injection detected on the domain controller?  | 10 |
