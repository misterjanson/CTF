...
In this lab we'll learn how FortiEDR deals with the malicous files used during the attack scenario. We'll also learn how powerful FortiEDR's Threat Hunting module can be and understand the information it provides to identify behaviors associated with attacket's tactics and techniques.
...
9. Can you find how to directly access the [Virus Total](https://www.virustotal.com/gui/home/upload) page for Lockbit.exe from the information presented here in the Threat Hunting module?
